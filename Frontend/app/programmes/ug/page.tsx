            ...
            <main className="flex-1 py-12 px-4 md:px-8 max-w-7xl mx-auto w-full mt-16">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
                        BACHELOR OF TECHNOLOGY <span className="text-[#5ea21a]">[B.TECH.]</span>
                    </h1>
                    <div className="mt-4 flex flex-wrap justify-center items-center gap-4 md:gap-8 text-lg font-medium text-gray-600">
                        <span className="flex items-center gap-2">
                            <Calendar className="w-5 h-5 text-[#5ea21a]" />
                            COURSE DURATION : <strong className="text-gray-900">FOUR YEARS</strong>
                        </span>
                        <span className="hidden md:inline text-gray-300">|</span>
                        <span className="flex items-center gap-2">
                            <Milestone className="w-5 h-5 text-[#eb8426]" />
                            COUNSELLING CODE : <strong className="text-[#eb8426]">VITB</strong>
                        </span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    {BTechBranches.map((branch, idx) => (
                        <Card key={idx} className="border-t-4 border-t-[#5ea21a] shadow-md hover:shadow-lg transition-all duration-300 bg-white">
                            <CardContent className="pt-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex justify-between text-sm text-gray-650">
                                        ...
                                        <span className="font-semibold text-gray-800">{branch.catA}</span>
                                    </div>
                                    <div className="flex justify-between text-sm text-gray-650">
                                        <span>Category 'B' Seats:</span>
                                        <span className="font-semibold text-gray-800">{branch.catB}</span>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                ...
                <div className="bg-[#fffee7] border-2 border-yellow-200 rounded-xl p-6 md:p-8 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="text-left md:text-right">
                        <div className="text-2xl md:text-3xl font-black text-[#5ea21a]">
                            Rs. 1,03,000.00 <span className="text-sm font-medium text-gray-500">per year</span>
                        </div>
                    </div>
                </div>
            </main>
